...
Name the project `doubly-linked-lists-in-java`.
...
After confirming that the **New Project** window looks similar to the screenshot below, select the **Create** button. The name of the project should be `doubly-linked-lists-in-java`, not `untitled`.
